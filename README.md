...
Navigate to [localhost:8888](http://localhost:8888). You should see your app running. Edit a component file in `src`, save it, and reload the page to see your changes.
